       ...
       <div class="row">
           <div class="col-lg-6 col-md-6">
               <div class="row left_bg justify-content-center">
                   ...
                   <div class="sign_up_frm">
                       <a href="{{ route('index') }}"><img  src="{{ asset('assets-main/images/logo.png') }}" alt="logo" class="img-fluid"></a>
                       <br><br>
                       <h4>Forgot Password</h4>
                       <p>Relax we often forget alot of <br> things, We got you covered.<br><br> Enter your Email to change password.</p>
                       <br>
                       ...
                       <form class="sign_frm" method="POST" action="{{ route('password.email') }}">
                           @csrf
                           ...
                           <div class="form-group">
                              <button type="submit" class="btn btn_sign">Send Email</button>


                              <div class="clearfix"></div>
                           </div><br>
                           <div class="hav_acnt"><span>Wait, Why am I here? <br>I Should <a href="{{ route('register') }}">Sign Up </a> or  <a href="{{ route('login') }}">Log In </a></span></div>
                       </form>
           ...
           <div class="col-lg-6 mobile_hide col-md-6">
               <div class="sign_up_img">
                   ...
                   <div class="img_bdy">
                       <img src="{{ asset('assets-main/images/forgot-pass.png') }}" alt="img" class="img-fluid">
                   </div>
                   <div class="img_ftr">
                    <ul>
