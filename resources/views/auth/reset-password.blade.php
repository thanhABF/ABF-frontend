           ...
           <div class="col-lg-6 col-md-6">
               <div class="row left_bg justify-content-center">
                   ...
                   <div class="sign_up_frm">
                       ...
                       <form class="sign_frm" method="POST" action="{{ route('password.update') }}">
                           @csrf
                           ...
                           <div class="form-group">
                              <label for="">Confirm Password</label>
                               <input id="password-field" type="password" class="form-control" name="password_confirmation"  placeholder="Enter Password">
                               <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password "></span>
                           </div>

                           <div class="form-group">
                              <button type="submit" class="btn btn_sign">Reset Password</button>
                           </div>
                       </form>
                   </div>
